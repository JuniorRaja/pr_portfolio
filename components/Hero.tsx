...
const Hero = () => {
  return (
    <div className="pb-20 pt-36">
      ...
      <div className="h-screen w-full dark:bg-slate-950 bg-white dark:bg-grid-white/[0.1] bg-grid-black/[0.2] flex items-center justify-center absolute top-0 left-0">
